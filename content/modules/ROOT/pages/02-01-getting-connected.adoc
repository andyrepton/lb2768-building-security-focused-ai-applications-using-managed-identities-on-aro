...
For the purposes of this training session, we have provisioned a single {ocp} cluster, with {rhoai} deployed on it. In addition we have set up AWS Bedrock and AWS OpenSearch that we will connect to via their respective APIs. 
